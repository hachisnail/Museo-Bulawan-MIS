...
const User = () => {
  ...
  const fetchUsers = () => {
    axios
      .get(`${API_URL}/api/auth/fetchUsers`, { withCredentials: true })
      .then((response) => {
  ...
  const fetchPendingInvitations = () => {
    setInviteError(null)
    axios
      .get(`${API_URL}/api/auth/invitations`, { withCredentials: true })
      .then((response) => {
              ...
              <div className="w-full h-full flex flex-col">
                <div className="w-full min-h-[30rem] border-t-1 py-10 border-t-[#373737] flex flex-col sm:flex-row sm:justify-between">
                  <div className="w-full h-full gap-y-4 flex flex-col">
                    ...
                    <span className="text-xl w-[25rem] text-[#9C9C9C]">
                      Manage system by users by assigning roles, updating
                      account details, and controlling access levels.
                    </span>
                    <button
                ...
                <div className="w-full h-fit sm:h-full gap-y-10 flex border-t-1 py-10 border-t-[#373737] flex-col sm:flex-row ">
                  <div className="w-full h-fit sm:h-full gap-y-4 flex flex-col">
                    ...
                    <span className="text-xl w-[25rem] text-[#9C9C9C]">
                      View and manage pending user invitations. Approve, resend,
                      or revoke invites to control system access.
                    </span>
                  </div>
